  ...
  return (
    <div className=" bg-primary font-LexendDeca text-white">
      ...
      <div className="flex justify-center pt-9 pb-8">
        <div className=" border-b-[1px] border-gray-400  h-[240px] w-[550px] ">
        ...
        <div className=" border-b-[1px] border-gray-400  h-[240px] w-[550px] pl-10">
          <div className="text-[18px] font-semibold">
      ...
      <div className=" flex justify-center ">
        <div className="w-[1100px] border-b border-gray-400 flex justify-between pb-8 font-thin">
      ...
      <div className="pt-8 flex justify-center ">
        <div className="w-[1100px] border-b border-gray-400 flex justify-between pb-8 font-light">
          <div className="max-w-[528px]">
            <h2 className="font-bold">Về chúng tôi</h2>

            <h3 className="mt-[14px] text-[12px] font-semibold">
              Vieclam24h.vn - Công Ty Cổ Phần Việc Làm 24h
            </h3>
            <div className="text-[12px] flex gap-1 flex-col font-thin">
              <p>
